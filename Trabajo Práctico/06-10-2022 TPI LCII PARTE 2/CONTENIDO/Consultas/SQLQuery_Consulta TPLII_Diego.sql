...
/* A los efcetos de evaluar el objetivo de ventas por volumen e importe y 
...
de su histórico de pedidos, se necesita determinar una consulta que verifique
 ...
 y determinar el importe del bono como un % del promedio ponderado de acuerdo a una escala 15% para importes superiores a $1000.000 y el resto 10%,
...
/*La gente de Finanzas necesita llevar un control de las distintas
...
alter procedure CONSULTA_GUIZZO_1
as
begin
declare @enunciado nvarchar(1000)
set @enunciado =  'La gente de Finanzas necesita llevar un control de las distintas
formas de cobro de las ventas realizadas para evaluar posibles inversiones
de efectivo a lo largo del año,mes por mes, para ello require una vista que
le permita obtener la información de los productos mas vendidos
en efectivo y su conversion en dolares al TC $ 300 por dolar'
